                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="name" id="name" value="{{ $role->name }}" placeholder="Enter name" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="slug" class="col-sm-2 control-label">Slug</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="slug" id="slug" value="{{ $role->slug }}" placeholder="Enter slug" autocomplete="off">
                            </div>
                        </div>
